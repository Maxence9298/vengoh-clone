      ...
      <section className="bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="w-12 h-12 mx-auto mb-3 bg-vengoh-primary rounded-full flex items-center justify-center">
              ...
              <h3 className="font-serif text-sm">Made in Europe</h3>
              <p className="text-xs text-gray-500 mt-1">Premium European fabrics</p>
            </div>
            <div>
              <div className="w-12 h-12 mx-auto mb-3 bg-vengoh-primary rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-vengoh-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-serif text-sm">Free Shipping</h3>
              <p className="text-xs text-gray-500 mt-1">On orders over &euro;150</p>
            </div>
            <div>
              <div className="w-12 h-12 mx-auto mb-3 bg-vengoh-primary rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-vengoh-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-serif text-sm">Easy Returns</h3>
            ...
            <div>
              ...
              <h3 className="font-serif text-sm">Premium Quality</h3>
              <p className="text-xs text-gray-500 mt-1">Designed for performance</p>
            </div>
          </div>
        </div>
      </section>
